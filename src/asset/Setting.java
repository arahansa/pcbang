...
public class Setting {
	...
	public static Rectangle bRectangle= new Rectangle(zeroPoint, bDimen); // 0, 0, 1600, 900
	public static Rectangle bpanRectangle= new Rectangle(panelPoint, bDimen); // 0, -30, 1600, 900
	
	//Panel Location
	public static Rectangle imgClockRectangle = new Rectangle(15, 20, 179, 149);
	public static Rectangle clockRectangle = new Rectangle(80, 53, 100, 100);
